...
Tool/service access	MCP (Model Context Protocol)
...
Graph pauses (interrupt()) and persists state
User reviews and approves / edits / rejects
Graph resumes from the checkpoint with the human decision applied
🛡️ Guardrails
